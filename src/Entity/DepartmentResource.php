 ...
 * @ORM\Entity(repositoryClass="Kookaburra\Departments\Repository\DepartmentResourceRepository")
...
class DepartmentResource
{
     ...
     * @var integer|null
     * @ORM\Id()
     * @ORM\Column(type="integer", columnDefinition="INT(8) UNSIGNED ZEROFILL AUTO_INCREMENT")
     * @ORM\GeneratedValue
     */
    private $id;
